      ...
      <main className="tela" style={{ paddingBottom: '30px', width: '100%', overflowX: 'hidden' }}>
        ...
        <form onSubmit={salvarFornecedor} className="form-padrao" style={{ width: '100%', marginTop: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <input type="text" name="cep" value={form.cep} onChange={handleChange} onBlur={buscarCEP} className="input-padrao" inputMode="numeric" />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '10px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', minWidth: 0 }}>
              ...
              <input type="text" name="numero" value={form.numero} onChange={handleChange} className="input-padrao" inputMode="numeric" />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <input type="text" name="telefone" value={form.telefone} onChange={handleChange} className="input-padrao" inputMode="numeric" />
          </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '10px' }}>
                <div style={{ minWidth: 0 }}>
                  <input type="text" name="telefone_vendedor" value={form.telefone_vendedor} onChange={handleChange} className="input-padrao" style={{ backgroundColor: 'white', width: '100%' }} inputMode="numeric" />
                </div>
